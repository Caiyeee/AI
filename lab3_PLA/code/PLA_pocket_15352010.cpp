...
double error(vector<int> w){
	...
	return err/(1.0*x.size());
}

int main(){
	//读取训练集
	f1.open("E:\\学习\\大三上\\人工智能\\实验\\lab3(PLA)\\lab3数据\\train.csv",ios::in);
	string line,s;
	...
	f1.open("E:\\学习\\大三上\\人工智能\\实验\\lab3(PLA)\\lab3数据\\val.csv",ios::in);
